  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 auto-rows-[300px] gap-4">
      <div className="p-2 flex items-center col-span-2">
        <div className="m-4 w-36 h-36 bg-white shadow-lg rounded-full shrink-0 grow-0 "></div>
        <div className="ml-4">
      ...
      <div className="col-span-2 lg:col-span-1 bg-neutral-100 border-2 rounded-xl row-span-3 p-4 py-8 flex flex-col gap-6 relative">
        <div className="h-36 p-4 bg-white rounded-md shadow-md">
          <span className="absolute inset-y-0 left-0 bg-blue-400 h-4 "></span>
        </div>
